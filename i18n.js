(function () {
  ...
  const messages = {
    en: {
      ...
      twofa_login_heading: "Two-factor authentication",
      twofa_required: "Enter your authenticator code to finish signing in.",
      twofa_nudge_title: "Enable two-factor authentication",
      twofa_nudge_body: "For your security, please turn on 2FA on your account.",
      label_code: "Code",
      btn_verify: "Verify",
      ...
      twofa_setup_note: "Scan the QR code with Google Authenticator, Authy, etc.",
      ...
      register_wait: "Check your email and click the verification link within 2 minutes.",
      register_wait_hint: "Stay on this page — you will be signed in automatically once verified.",
      register_countdown: "Time left: {sec}s",
      register_countdown_expired: "Time expired",
    ...
    tr: {
      ...
      twofa_login_heading: "İki adımlı doğrulama",
      twofa_nudge_title: "2FA’yı etkinleştirin",
      twofa_nudge_body: "Güvenliğiniz için lütfen hesabınızda iki adımlı doğrulamayı (2FA) açın.",
      label_code: "Kod",
      btn_verify: "Doğrula",
      ...
      twofa_setup_note: "Google Authenticator, Authy vb. ile QR kodu tara.",
      twofa_manual_key: "Veya anahtarı elle gir:",
      ...
      register_wait: "E-postanı kontrol et; doğrulama linkine 2 dakika içinde tıkla.",
      register_wait_hint: "Bu sayfada kal — doğrulanınca otomatik giriş yapılır.",
      register_countdown: "Kalan süre: {sec} sn",
      register_countdown_expired: "Süre doldu",
    ...
    es: {
      ...
      twofa_login_heading: "Autenticación en dos pasos",
      twofa_nudge_title: "Activa la autenticación en dos pasos",
      twofa_nudge_body: "Por tu seguridad, activa 2FA en tu cuenta.",
      label_code: "Código",
    ...
    zh: {
      ...
      twofa_login_heading: "两步验证",
      twofa_nudge_title: "请启用两步验证",
      twofa_nudge_body: "为了您的账户安全，请开启 2FA 两步验证。",
      label_code: "验证码",
      btn_verify: "验证",
      btn_register: "注册",
      resend_note: "没收到验证邮件？",
